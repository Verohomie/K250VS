...
#define STRING_CONFIG_H_AUTHOR "(UltiBots K250VS-RAMBO-TX-FSR-RCM)" // Who made the changes.
...
#define CUSTOM_MENDEL_NAME "K250VS-TX-FSR"
...
#define DEFAULT_DELTA_DIAGONAL_ROD 288.0 // mm
...
#define AUTOCALIBRATION_PRECISION 0.10 // mm
