...
static void lcd_prepare_menu()
{
    ...
    MENU_ITEM(gcode, "FSR CAL10", PSTR("G30 A0.10 D288.0"));
    MENU_ITEM(gcode, "FSR CAL05", PSTR("G30 A0.05 D288.0"));
    MENU_ITEM(gcode, "SPAGHETTI", PSTR("M206 Z-40.0"));
    MENU_ITEM(gcode, "ZUP 60", PSTR("M206 Z-0.60"));
    MENU_ITEM(gcode, "ZUP 50", PSTR("M206 Z-0.50"));
    MENU_ITEM(gcode, "ZUP 40", PSTR("M206 Z-0.40"));
	MENU_ITEM(gcode, "ZUP 30", PSTR("M206 Z-0.30"));
	MENU_ITEM(gcode, "ZUP 20", PSTR("M206 Z-0.20"));
	MENU_ITEM(gcode, "ZUP ZERO", PSTR("M206 Z-0.0"));
    MENU_ITEM(gcode, "Save To EEPROM", PSTR("M500"));
    MENU_ITEM(gcode, "Restore", PSTR("M502"));
#if PS_ON_PIN > -1
    if (powersupply)
    {
