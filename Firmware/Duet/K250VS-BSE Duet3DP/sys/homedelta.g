; Homing file for RepRapFirmware on Kossel250
...
; I just need a few lines of very long drawn out comments in order to get the files size larger so this will upload
; I just need a few lines of very long drawn out comments in order to get the files size larger so this will upload
; I just need a few lines of very long drawn out comments in order to get the files size larger so this will upload
; I just need a few lines of very long drawn out comments in order to get the files size larger so this will upload
; I just need a few lines of very long drawn out comments in order to get the files size larger so this will upload
